...
SELECT product_id, product_name, (
	CASE 
		...
		WHEN product_qty_type IS NOT NULL
			THEN 'bulk'
	END
...
SELECT vendor_id, COUNT(booth_number) AS total_booth_rentals
...
SUM(cp.quantity * cp.cost_to_customer_per_qty) AS total_spent FROM customer c
